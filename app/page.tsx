...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center pt-16 px-4">
      <h1 className="text-4xl md:text-5xl font-bold mb-4 text-center">Hi, I'm Minh Quý</h1>
      <p className="text-xl md:text-2xl text-lightGray mb-8 text-center">A Researcher & CS Freshman</p>
      ...
      <p className="text-lightGray mb-8 text-center max-w-2xl">
        I'm passionate about AI, PINNs, and Computer Vision. Explore my work below.
      </p>
    </div>
  )
}
