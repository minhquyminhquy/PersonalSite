...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center pt-16 px-4">
      ...
      <p className="text-xl md:text-2xl text-lightGray mb-8 text-center">CS Freshman & Runner</p>
      ...
      <p className="text-lightGray mb-8 text-center max-w-2xl">
        Highly motivated student with enthusiasm in Data Science and AI/ML.   
      </p>
    </div>
  )
}
